...
-- ---------------------------------------------------------------------------
-- mailbox_accounts
-- Shared mailbox metadata and sync health for outreach workflows.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- outreach_threads
-- One active outreach thread per user + listing + contact email.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- outreach_messages
-- Inbound and outbound email messages, including unmatched preserved inbound mail.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- outreach_events
-- Immutable workflow transition log.
-- ---------------------------------------------------------------------------
...
-- Links inbound email attachments to listing documents.
-- ---------------------------------------------------------------------------
