...
export const scrapeRunsTotal = new Counter({
  name: 'immoradar_scrape_runs_total',
...
export const scrapePagesTotal = new Counter({
  name: 'immoradar_scrape_pages_total',
...
export const scrapeListingsDiscovered = new Counter({
  name: 'immoradar_scrape_listings_discovered_total',
...
export const scrapeErrorsTotal = new Counter({
  name: 'immoradar_scrape_errors_total',
...
export const normalizationTotal = new Counter({
  name: 'immoradar_normalization_total',
...
export const rawSnapshotRate = new Counter({
  name: 'immoradar_raw_snapshots_total',
...
export const versionCreationRate = new Counter({
  name: 'immoradar_versions_created_total',
...
export const scoringDuration = new Histogram({
  name: 'immoradar_scoring_duration_seconds',
...
export const alertsCreatedTotal = new Counter({
  name: 'immoradar_alerts_created_total',
...
export const alertLagSeconds = new Histogram({
  name: 'immoradar_alert_lag_seconds',
...
export const apiRequestDuration = new Histogram({
  name: 'immoradar_api_request_duration_seconds',
...
export const alertDeliveryTotal = new Counter({
  name: 'immoradar_alert_delivery_total',
...
export const alertDeliveryDuration = new Histogram({
  name: 'immoradar_alert_delivery_duration_seconds',
...
export const pushTokensActive = new Gauge({
  name: 'immoradar_push_tokens_active',
